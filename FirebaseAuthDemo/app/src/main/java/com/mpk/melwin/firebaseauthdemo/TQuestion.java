...
public class TQuestion extends AppCompatActivity {
    ...
    DatabaseReference databaseQuestion,databaseQuestion1,databaseQuestion2,databaseQuestion3,databaseReference;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                startActivity(new Intent(TQuestion.this,ProfileActivity.class));
            }
        });
    ...
    private void updateQuestion() {
        ...
        if (j <= i-1) {
          ...
          //  FirebaseUser user = firebaseAuth.getCurrentUser();
            //databaseReference.child(user.getUid()).setValue(abc);
            finish();
            startActivity(new Intent(TQuestion.this, ProfileActivity.class));
